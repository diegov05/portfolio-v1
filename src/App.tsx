...
const App: React.FC<IAppProps> = () => {
  return (
    <>
      ...
      <div className='absolute -z-10 s:max-3xl:top-[50rem] s:max-3xl:-left-[40rem] xl:w-[60rem] xl:h-[60rem] xl:top-[50rem] xl:-left-[40rem] opacity-80 blur-[15rem] w-[60rem] h-[60rem] bg-sky-700' />
      <div className='absolute -z-10 xl:w-[100rem] xl:h-[100rem] xl:top-[50rem] xl:-left-[40rem] opacity-80'>
