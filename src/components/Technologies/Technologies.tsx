    ...
    return (
        <div className='w-full flex flex-row flex-wrap xs:max-md:justify-between xs:max-sm:gap-2 sm:max-3xl:gap-4 sm:max-3xl:justify-end'>
            {technologiesData.map((tech) => (
                <div key={tech.name} className="flex flex-col justify-start items-center gap-6 bg-zinc-700/20 p-2.5 s:max-3xl:p-4 backdrop-blur-xl rounded-3xl border border-t-zinc-600 border-l-zinc-600 basis-1/4">
                    {tech.name === "NextJS" ?
                    ...
                    <div className='flex flex-col justify-start items-start gap-2 s:max-3xl:gap-6'>
