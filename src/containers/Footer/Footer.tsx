...
const Footer: React.FC<IFooterProps> = () => {
    return (
        <div className='relative flex flex-col items-center md:max-4xl:items-start gap-12 pb-0 py-10 px-10 sm:max-4xl:px-20'>
            ...
            <a href="mailto: diegovs_@outlook.com"><button data-aos="fade-up" className='gradient-bg font-bold text-bg px-5 py-2.5 rounded-2xl text-xs md:max-4xl:text-lg'>Send Email</button></a>
            <div data-aos="fade-up" className='flex flex-col justify-center items-center w-full'>
                <img src={images.footerImage} className='w-[40rem]' alt="" />
            </div>
        </div >
    );
}
