...
const Mockups: FC = () => {
    return (
        <div className='flex flex-col items-center gap-24 py-10 px-10 sm:max-4xl:px-20'>
            <div id='samples-section' data-aos="fade-right" className='flex flex-col gap-1 sm:max-lg:gap-3 lg:max-4xl:gap-5 text-center w-full s:max-4xl:text-start h-full'>
